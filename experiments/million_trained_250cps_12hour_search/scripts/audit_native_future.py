...
variants=[('future_mouse',160,400,1000,replace(common,native_anchor_all=4,future_upgrade_mask=32768)),
          ('future_finger',160,400,1000,replace(common,native_anchor_all=4,future_upgrade_mask=8)),
          ('future_both',160,400,1000,replace(common,native_anchor_all=4,future_upgrade_mask=32776)),
          ('future_both_half',160,400,1000,replace(common,native_anchor_all=4,future_upgrade_mask=32776,future_weight=.5)),
          ('future_mouse_half',160,400,1000,replace(common,native_anchor_all=4,future_upgrade_mask=32768,future_weight=.5)),
          ('future_both400',400,1000,5000,replace(common,native_anchor_all=4,future_upgrade_mask=32776))]
rows=[]
...
(work/'audit_native_future.json').write_text(json.dumps(rows,indent=2)+'\n')
