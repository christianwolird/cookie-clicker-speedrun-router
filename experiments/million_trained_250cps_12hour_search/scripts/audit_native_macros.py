...
work=Path('/tmp/ccsr-trained-12h-20260914');plan=load_route(work/'incumbent_start.route');samples=[];state=initial_gamestate(plan)
...
(work/'audit_native_macros.json').write_text(json.dumps(rows,indent=2)+'\n')
