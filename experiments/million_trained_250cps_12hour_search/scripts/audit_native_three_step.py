...
variants=[('three500_mouse',160,400,1000,replace(common,native_anchor_all=4,three_step=True,two_step_pool=500,two_step_weight=1,lookahead_branches=4,future_upgrade_mask=32768)),('three3000_mouse',160,400,1000,replace(common,native_anchor_all=4,three_step=True,two_step_pool=3000,two_step_weight=1,lookahead_branches=4,future_upgrade_mask=32768))]
rows=[]
...
(work/'audit_native_three_step.json').write_text(json.dumps(rows,indent=2)+'\n')
