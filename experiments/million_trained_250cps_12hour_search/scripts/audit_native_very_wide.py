...
variants=[('wide2500_mouse',2500,2000,5000,replace(common,native_anchor_all=4,future_upgrade_mask=32768))]
rows=[]
...
(work/'audit_native_very_wide.json').write_text(json.dumps(rows,indent=2)+'\n')
